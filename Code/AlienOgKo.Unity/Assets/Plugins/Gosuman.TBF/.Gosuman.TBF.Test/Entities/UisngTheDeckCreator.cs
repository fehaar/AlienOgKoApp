...
{
    public class UisngTheDeckCreator : xSpec
    {
        [Fact]
        ...
        //    {
        //        realBlueprint1 = new TestBlueprint { Id = "Blueprint1", Tags = new[] { "Real" } };
        //        realBlueprint2 = new TestBlueprint { Id = "Blueprint2", Tags = new[] { "Real" } };
        //        creator = new TestDeckCreator()
        //        {
        //            Blueprints = new[]
        //            {
